...
public class LevelDBClient extends site.ycsb.DB {
...
*/
  ...
  private static byte[] serialize(Map<String, ByteIterator> hash)
    throws IOException {
...
*/
  ...
  private DBIterator _readRm(String rowStartKey, Set<String> fields,
    Map<String, ByteIterator> result, DBIterator dbIter)
    throws IOException {
  ...
  public Status readRm(String table, String key, Set<String> fields,
  ...
  public Status readCm(String table, String key, Set<String> fields,
      Map<String, ByteIterator> result) throws IOException {
  ...
  public Status readFr(String table, String key, Set<String> fields,
      Map<String, ByteIterator> result)
        throws IOException, ClassNotFoundException {
...
*/
  ...
  private Status _deleteRm_(String table, String key) {
    try {
        DBIterator dbIter = db.iterator();
  ...
  private Status deleteRm(String table, String key) {
  ...
  private Status deleteCm(String table, String key) {
    String[] fieldArray = new String[fieldArrayIdx.length];
    for (int i = 0; i < fieldArray.length; i++)
        fieldArray[i] = "field" + Integer.toString(i);
  ...
  private Status _scan(String table, String startKey, int recordCount,
  ...
  private Status _scanFr(String table, String startKey,
